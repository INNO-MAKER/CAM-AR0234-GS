...
└── jetson-orin-nano-driver/
    ├── ar0234-jetson-driver-upstream-kurokesu.tar.gz          ← Upstream open-source driver (Kurokesu)
    └── 5.15.148/
...
| [`jetson-orin-nano-driver/ar0234-jetson-driver-upstream-kurokesu.tar.gz`](./jetson-orin-nano-driver/ar0234-jetson-driver-upstream-kurokesu.tar.gz) | Upstream open-source AR0234 Jetson kernel driver by [Kurokesu](https://github.com/Kurokesu/ar0234-mipi-nvidia) (DKMS, V4L2, JetPack 6) |
